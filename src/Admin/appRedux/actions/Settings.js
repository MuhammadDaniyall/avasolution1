...
export const getResourceData = (id) => {
  return (dispatch) => {
    ...
    return axios
      .get(`http://localhost:8000/resource`, { params:{id: id}
      })
      .then(({ data }) => {
        if (data.success) {
...
export const updateService = (params) => {
  ...
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .put(`service/${params.ID}`, formData)
      .then(({ data }) => {
        if (data.success) {
          dispatch({ type: FETCH_SUCCESS });
...
export const addField = (params) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .post('waitlist/clientFieldAdd ', params)
      .then(({ data }) => {
        if (data.success) {
...
export const updateField = (params) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .post('waitlist/clientFieldUpdate', params)
      .then(({ data }) => {
        if (data.success) {
...
export const getField = (params) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .get(`waitlist/clientField/${params}`)
      .then(({ data }) => {
        if (data.success) {
          dispatch({ type: FETCH_SUCCESS });
...
export const enableField = (ID) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .post(`waitlist/setenableField/${ID}`)
      .then(({ data }) => {
        if (data.success) {
          message.success('Updated Successfully!');
          dispatch({ type: FETCH_SUCCESS });
...
export const deleteClientField = (ID) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .delete(`waitlist/deleteClientField/${ID}`)
      .then(({ data }) => {
        if (data.success) {
...
export const getWaitListSettings = (userId) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .get(`waitlist/getWaitListSettings/${userId}`)
      .then(({ data }) => {
        if (data.success) {
          dispatch({ type: FETCH_SUCCESS });
...
export const updateWaitListSetting = (params) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .post(`waitlist/updateWaitListSettings`, params)
      .then(({ data }) => {
        if (data.success) {
          message.success('Updated successfully!');
          dispatch({ type: FETCH_SUCCESS });
...
export const ResetSettings = (params) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .post(`waitlist/ResetSettings`, params)
      .then(({ data }) => {
        if (data.success) {
          message.success('Updated successfully!');
          dispatch({ type: FETCH_SUCCESS });
...
export const ClearData = (params) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .post(`waitlist/ClearData`, params)
      .then(({ data }) => {
        if (data.success) {
          message.success('Updated successfully!');
          dispatch({ type: FETCH_SUCCESS });
...
export const DeleteWaitList = (params) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .post(`waitlist/DeleteWaitList`, params)
      .then(({ data }) => {
        if (data.success) {
          message.success('Updated successfully!');
          dispatch({ type: FETCH_SUCCESS });
...
export const getBookingSettings = (userId) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .get(`booking/getBookingSettings/${userId}`)
      .then(({ data }) => {
        if (data.success) {
          dispatch({ type: FETCH_SUCCESS });
...
export const updateBookingSetting = (params) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .post(`booking/updateBookingSettings`, params)
      .then(({ data }) => {
        if (data.success) {
          message.success('Updated successfully!');
          dispatch({ type: FETCH_SUCCESS });
...
export const getAlertSettings = (userId) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .get(`alert/getAlertSetting/${userId}`)
      .then(({ data }) => {
        if (data.success) {
          dispatch({ type: FETCH_SUCCESS });
...
export const updateAlertSetting = (params) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .post(`alert/updateAlertSetting`, params)
      .then(({ data }) => {
        if (data.success) {
          message.success('Updated successfully!');
          dispatch({ type: FETCH_SUCCESS });
...
export const getBusinessInfoSetting = (user_id) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .get(`BusinessInfo/getBusinessSetting/${user_id}`)
      .then(({ data }) => {
        if (data.success) {
          dispatch({ type: FETCH_SUCCESS });
...
export const updateBusinessInfoSetting = (params) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .post(`BusinessInfo/updateBusinessInfoSettings`,params)
      .then(({data}) => {
        if(data.success){
          dispatch({type:FETCH_SUCCESS});
...
export const getLocalizationSetting = (user_id) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .get(`Localization/getLocalizationSettings/${user_id}`)
      .then(({ data }) => {
        if (data.success) {
          dispatch({ type: FETCH_SUCCESS });
...
export const updateLocalizationSetting = (params) => {
  return (dispatch) => {
    dispatch({ type: FETCH_START });
    return axios
      .post(`Localization/updateLocalizationSettings`,params)
      .then(({data}) => {
        if(data.success){
          dispatch({type:FETCH_SUCCESS});
