...
// import SignInByCustomer from '../../CustomerSide/pages/Auth/SignIn';
import SignUp from '../../pages/Auth/SignUp';
// import SignUpByCustomer from '../../CustomerSide/pages/Auth/SignUp';
...
class App extends Component {
  ...
  render() {
    ...
    if (location.pathname === '/admin') {
      ...
      }else if (initURL === '' || initURL === '/' || initURL === '/signInByCustomer') {
        return <Redirect to={'/admin/dashboard'} />;
      }else {
      ...
      <ConfigProvider locale={currentAppLocale.antd}>
        <IntlProvider locale={currentAppLocale.locale} messages={currentAppLocale.messages}>
          <Switch>
            ...
            {/* <Route exact path="/signInByCustomer" component={SignInByCustomer} /> */}
            {/* invite component */}
            ...
            {/* <Route exact path="/signUpByCustomer" component={SignUpByCustomer} /> */}
