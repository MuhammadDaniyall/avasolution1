...
const CustomerModal = (props) => {
  ...
  const { title, state, visible, formdata, handleSubmit, closeModal, customerData, type } = props;
    ...
    >
      <Form form={form} layout={'vertical'}>
        ...
        <Row className={"gx-flex-sm-row"}>
          ...
          >
            <Input placeholder="Staff name" prefix={<Account style={{ color: '#a2aabd', fontSize: 18 }} />} />
          </Form.Item>
          ...
          {/* <Form.Item className={'gx-flex-1'} name="customer_group_id" label="Customer ID" style={{ paddingLeft: 5 }}>
            <Input placeholder="Staff ID" prefix={<Identifier style={{ color: '#a2aabd', fontSize: 18 }} />} />
          </Form.Item> */}
        </Row>
        <Row className={"gx-flex-sm-row"}>
          {/* <Form.Item className={'gx-flex-1'} name="email" label="Email" style={{ paddingRight: 5 }}
          ...
          <Form.Item className={'gx-flex-1'} name="phone" label="Phone">
            {/* <PhoneInput
              country={'ca'}
              inputStyle={{
                width: '100%',
              ...
              buttonStyle={{ backgroundColor: '#fff', borderRight: 0, paddingRight: 5 }}
            /> */}
          </Form.Item>
...
const mapStateToProps = ({ customer, settings }) => {
  ...
  return { customerData, clientFieldData, resourceData };
};
